...
- (void)viewDidLoad {
    ...
    NSArray *textfields = @[self.accountTField, self.keyTField];
    for (UITextField *textfield in textfields) {
        UILabel *leftView = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 15, 30)];
        textfield.leftViewMode = UITextFieldViewModeAlways;
        textfield.leftView = leftView;
    }
}
- (IBAction)backgoundHandle:(id)sender {
    [self.accountTField resignFirstResponder];
    [self.keyTField resignFirstResponder];
}
