...
- (void)viewDidLoad {
    ...
    [self.actionArray addObject:@[@"enterPiePage", @"enterDatePickerPage", @"enterSegmentPage", @"enterAnalysisPage", @"enterQRScanPage", @"enterFlatButtonPage", @"enterSlidePage", @"enterCirclePage", @"enterAlertPage"]];
...
- (void)enterAlertPage {
    [AlertController alertByTitle:@"标题" message:@"这里是内容" delegate:nil okayButtonTitle:@"确定" cancelButtonTitle:@"取消"];
}
