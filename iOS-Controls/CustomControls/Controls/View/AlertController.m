...
@property (copy, nonatomic) AlertActionHandler handler;
@end
...
+ (instancetype)instanceWithTitle:(NSString *)title message:(id)message delegate:(id)delegate okayButtonTitle:(NSString *)okayButtonTitle cancelButtonTitle:(NSString *)cancelButtonTitle accessory:(NSUInteger)accessory {
    AlertView *alertView = [[[NSBundle mainBundle] loadNibNamed:@"AlertView" owner:nil options:nil] firstObject];
...
+ (instancetype)instanceWithTitle:(NSString *)title message:(id)message okayButtonTitle:(NSString *)okayButtonTitle cancelButtonTitle:(NSString *)cancelButtonTitle handler:(AlertActionHandler)handler {
...
+ (instancetype)instanceWithTitle:(NSString *)title message:(id)message okayButtonTitle:(NSString *)okayButtonTitle cancelButtonTitle:(NSString *)cancelButtonTitle accessory:(NSUInteger)accessory handler:(AlertActionHandler)handler {
    AlertView *alertView = [[[NSBundle mainBundle] loadNibNamed:@"AlertView" owner:nil options:nil] firstObject];
    [alertView setTitle:title message:message okayTitle:okayButtonTitle cancelTitle:cancelButtonTitle];
 ...
 * 初始化方法
 */
- (instancetype)initWithHandler:(AlertActionHandler)handler {
    return [self initWithHandler:handler accessory:-1];
}
- (instancetype)initWithHandler:(AlertActionHandler)handler accessory:(NSUInteger)accessory {
    if (self = [super init]) {
